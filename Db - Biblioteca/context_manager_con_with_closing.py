...
# Ya que parece que 'with' para sqlite solo gestiona las transacciones que se dan en la conexión, lo mejor es darle un cierre explicito a la base de datos
with closing(sqlite3.connect("biblioteca_avanzada.db")) as conexion:
